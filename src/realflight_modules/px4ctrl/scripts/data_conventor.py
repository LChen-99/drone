...
from mavros_msgs.msg import BatteryStatus, AttitudeTarget, RCOut
...
sub_pwm_topic = "/iris_0/mavros/servo_output_raw"
sub_attitude_topic = "/iris_0/mavros/setpoint_raw/attitude"
num_count = 0
...
output_file_name = "/home/luochen/project_doc/drone_msproject/neural-fly/my_data/training/custom_land_0_random.csv"
rospy.sleep(90)
